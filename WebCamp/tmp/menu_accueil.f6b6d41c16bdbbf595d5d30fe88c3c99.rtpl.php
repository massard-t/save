<?php if(!class_exists('raintpl')){exit;}?><!-- <div class="ui inverted vertical masthead center aligned segment" style="min-height: 150px;"> -->
<!-- Following Menu -->
...
<div class="ui large top fixed hidden menu inverted blue">
    <div class="ui container">
        ...
        <div class="right menu">
            ...
            <div class="ui popup bottom transition hidden">
                <div class="ui two column relaxed equal height divided grid">
                    ...
                    <div class="column">
                        <div class="item">
                            <a href="/src/log_out.php" class="ui button fade animated blue inverted">
                                <div class="visible content">
                                    Log out
                                </div>
                                <div class="hidden content">
...
<div class="ui vertical sidebar labeled icon transition fade menu">
    ...
    <a class="item disabled">
       ...
       <div class="ui label" style="padding:5px; margin: 0 auto">Connectez vous</div><br />
    </a>
    <a class="item disabled">
...
<div class="ui container">
    <div class="ui secondary large inverted pointing menu">
        <!--
            ...
            -->
        <a class="ui inverted open-sidebar view-ui item blue">
        <img src="./../images/logo.png" width="5px" style="display: inline; padding-right: 5px;"></img> MENU&nbsp;<i class="fa fa-arrow-right"></i> 
        </a>
        <?php if( $co==0 ){ ?>
        ...
        <div class="right menu">
            <div class="ui pointing top dropdown button basic inverted" style="margin-bottom: 12px; margin-top: 12px; margin-right: 60px;">
                ...
                <div class="menu">
                    <div class="header">Gestion utilisateur</div>
                    <div class="item">
                        <a class="ui button fade animated blue login_button" style="background-color: #167e95; opacity: 0.85;">
                            <div class="visible content">
                                Se connecter
                            </div>
                            <div class="hidden content">
                    ...
                    <center>
                        <div class="item inverted">
                            <a class="ui button fade animated colored red register_button" style="margin: 0 auto">
                                <div class="visible content">
                                    S'inscrire
                                </div>
                                <div class="hidden content">
