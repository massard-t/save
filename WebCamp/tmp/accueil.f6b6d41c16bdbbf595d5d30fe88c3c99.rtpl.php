...
<html>
 ...
 <!--        <link rel="apple-touch-icon" sizes="57x57" href="./images/apple-icon-57x57.png">
        ...
        <meta http-equiv="refresh" content="0;URL=/src/profil.php">
        <?php } ?>
    ...
    <body>
        <?php $tpl = new RainTPL;$tpl->assign( $this->var );$tpl->draw( "modal_accueil" );?>
        ...
        <?php $tpl = new RainTPL;$tpl->assign( $this->var );$tpl->draw( "menu_accueil" );?>
        ...
        <div class="ui text container">
            ...
            <h1 class="ui inverted header">
                ...
                <a href=""><img src="./images/logo.png" width="200px" style="margin-top: 50px;"></img></a><br />
        ...
        <br /><br />
        <div class="ui animated colored green fade button large register_button" tabindex="0">
            <div class="visible content">Maintenant !</div>
        ...
        <!--</p>
            ...
            -->
 <?php $tpl = new RainTPL;$tpl->assign( $this->var );$tpl->draw( "footer_accueil" );?>
