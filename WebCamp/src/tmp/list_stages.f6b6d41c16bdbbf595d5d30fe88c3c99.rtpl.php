                        ...
                        <div class="content">
                          ...
                          <?php $counter2=-1; if( isset($value1) && is_array($value1) && sizeof($value1) ) foreach( $value1 as $key2 => $value2 ){ $counter2++; ?>
                           ...
                           <?php if( $key2=='skills' ){ ?>
                                ...
                                <div style="padding-bottom: 5px;" class="ui label colored teal">Competences requises</div> <?php echo $value2;?> <br /><br />
                           ...
                           <?php if( $key2=='society' ){ ?>
                                ...
                                <div style="padding-bottom: 5px;" class="ui label colored teal">Société</div> <?php echo $value2;?> <br /><br />
                           ...
                           <?php if( $key2=='date' ){ ?>
                                ...
                                <div class="ui label colored teal">Date</div> <?php echo $value2;?> <br /><br />
                              </div>  
                           <?php } ?>

                           <?php if( $key2=='description' ){ ?>

                              <div class="ui seven wide column segment piled">
                                <div class="ui label right floating colored orange" style="left: 90% !important">Description</div> <?php echo $value2;?>
                           ...
                           <div class="ui one column stackable center aligned page grid">
                             <div class="column twelve wide">
                                ...
                                <a style="margin-bottom: 20px;" class="ui button large colored orange" href="/src/get_stages.php?id=<?php echo $value2;?>">Postuler</a>
                             </div>
                          </div>
                           <?php } ?>
