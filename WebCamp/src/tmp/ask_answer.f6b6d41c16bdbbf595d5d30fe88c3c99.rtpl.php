                      ...
                      <div class="event">
                        <div class="content">
                          ...
                          <?php $counter2=-1; if( isset($value1) && is_array($value1) && sizeof($value1) ) foreach( $value1 as $key2 => $value2 ){ $counter2++; ?>
                           ...
                           <?php if( $key2=='firstname' ){ ?>

                           
                              <div class="ui seven wide column">
                                <div style="padding-bottom: 5px;" class="ui label basic colored blue">Prenom</div> <?php echo $value2;?> <br /><br />

                           <?php } ?>

                           <?php if( $key2=='lastname' ){ ?>

                           <div style="padding-bottom: 5px;" class="ui label basic colored blue">Nom</div> <?php echo $value2;?> <br /><br />
                           <?php } ?>

                           <?php if( $key2=='place' ){ ?>


                                <div style="padding-bottom: 5px;" class="ui label colored teal">Lieu</div> <?php echo $value2;?> <br /><br />
                           ...
                           <?php if( $key2=='mail' ){ ?>
                                ...
                                <div style="padding-bottom: 5px;" class="ui label colored teal">Adresse email</div> <?php echo $value2;?> <br /><br />
                           ...
                           <div class="ui one column stackable center aligned page grid">
                             <div class="column twelve wide">
                                <div class='anchor' id="<?php echo $value2;?>"></div>
                                <a style="margin-bottom: 20px;" class="ui button basic large colored orange" href="/user.php?user_id=<?php echo $value2;?>">Voir le profil du stagiaire</a>
                             </div>
                            </div>
                            <div class="ui two grid stackable center aligned page grid">
                            <div class="column eight wide">
                                <div class='anchor' id="<?php echo $value2;?>"></div>
                                <a style="margin-bottom: 20px;" class="ui button large colored green" href="/answer_intern.php?id=<?php echo $value2;?>&choice=accept">Accepter</a>
                             </div>
                             <div class="column eight wide">
                                <div class='anchor' id="<?php echo $value2;?>"></div>
                                <a style="margin-bottom: 20px;" class="ui button large colored red" href="/answer_intern.php?id=<?php echo $value2;?>&choice=delete">Refuser</a>
                             </div>
                             </div>                          
                           <?php } ?>
