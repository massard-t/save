    ...
    <div class="ui text container">
    	<?php if( $message==true ){ ?>
                ...
                <div class='ui positive message'>
                  ...
                  <p>Le role de l'utilisateur a correctement été modifié
                </p></div>
    	<?php } ?>
          ...
          <h3 class="ui header">
            ...
            <div class="ui grid" style="padding-top: 20px; margin: 0 auto">
              <div class="twenty column row">
                  <div class="column">
                    <div class="ui feed">
                    <?php $counter1=-1; if( isset($user_list) && is_array($user_list) && sizeof($user_list) ) foreach( $user_list as $key1 => $value1 ){ $counter1++; ?>
                      ...
                      <div class="event">
                        <div class="content">
                          ...
                          <div class="summary">
                           <?php echo $value1;?> <a class="ui button small basic colored green" href="/src/change_user_role.php?id=<?php echo $key1;?>">Ne peut pas deposer de demandes de stages</a>
                          </div>
