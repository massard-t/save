            ...
            <div class="ui grid" style="padding-top: 20px; margin: 0 auto">
              <div class="twenty column row">
                  <div class="column">
                    ...
                    <iframe src="/src/position.php" style="border:0px #FFFFFF none; margin: 0 auto; margin-left: 10px;" name="myiFrame" scrolling="yes" frameborder="1" marginheight="0px" marginwidth="0px" height="400px" width="100%" class="ui image bordered rounded"></iframe>
                        </div>
                      </div>
                      <div class="ui header message info">
                        <h4>La geolocalisation peut ne pas être précise en fonction des conditions des utilisateurs.</h4>
                      </div>
                    </div>
