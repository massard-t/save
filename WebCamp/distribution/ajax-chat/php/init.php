...
function chat_chk($username, $password, &$gender, &$status)
{
  ...
  $mysqli_username = 'bonanza';
  $mysqli_password = 'mot de passe bonanza';
  $mysqli_database = 'data_base';

  // Enter the location of user data in MySQL database
  $mysqli_table          = 'Users';
  $mysqli_username_field = 'email';
  $mysqli_password_field = 'password';

  // The code bellow should work without modification for most users
  mysqli_connect('localhost', $mysqli_username, $mysqli_password);
  ...
  $result   = mysqli_query("select * from $mysqli_table where $mysqli_username_field = '$username' and ($mysqli_password_field = '$password' or $mysqli_password_field = MD5('$password') or MD5($mysqli_password_field) = '$password' or $mysqli_password_field = MD5(MD5('$password')) or MD5(MD5($mysqli_password_field)) = '$password')");
  echo 
  global $chat_data;
